...
public class testeVenda {
    ...
    public static Collection<Object[]> getParameters(){
        Object[][] resposta = new Object[][] {
            {new Cliente("André", TipoCliente.PADRAO, new Endereco("TO", false)), Arrays.asList(new Produto("P001", "Notebook", 2000.00, "unidade"), new Produto("P002", "Fita Métrica", 25.00, "metro"), new Produto("P003", "Celular", 1256.92, "unidade")), FormaPagamento.CARTAO_CREDITO, "5623 1421 9432 2331", "2024-05-07T14:23:45", 3832.03, 0.0, 25.00, 393.83, 131.28, 0.0, "07/05/2024 14:23:45"},
            {new Cliente("Alice", TipoCliente.ESPECIAL, new Endereco("DF", true)), Arrays.asList(new Produto("P004", "Notebook Gamer", 6350.00, "unidade"), new Produto("P005", "Caneta Preta", 10.00, "unidade"), new Produto("P006", "Caixa de Cartões", 6.55, "unidade")), FormaPagamento.CARTAO_CREDITO, "5623 8411 6217 2962", "2024-05-10T09:52:10", 6762.78, 751.25, 1.50, 1145.98, 0.0, 0.0, "10/05/2024 09:52:10"},
            {new Cliente("Lucileia", TipoCliente.PRIME, new Endereco("BA", false)), Arrays.asList(new Produto("P007", "Geladeira", 7523.20, "unidade"), new Produto("P002", "Fita Métrica", 25.00, "metro"), new Produto("P008", "Torneira", 56.92, "peça")), FormaPagamento.CARTAO_CREDITO, "4296 1321 9432 2331", "2024-05-10T21:00:45", 7939.74, 882.19, 0.0, 912.61, 304.21, 441.10, "10/05/2024 21:00:45"},
            {new Cliente("Pedro", TipoCliente.ESPECIAL, new Endereco("MG", true)), Arrays.asList(new Produto("P001", "Notebook", 2000.00, "unidade"), new Produto("P002", "Fita Métrica", 25.00, "metro"), new Produto("P003", "Celular", 1256.92, "unidade")), FormaPagamento.CARTAO_CREDITO, "4296 1334 8543 1229", "2024-05-17T10:13:15", 3047.72, 761.41, 2.10, 393.83, 131.28, 0.0, "17/05/2024 10:13:15"}
        };
        return Arrays.asList(resposta);
    }

    public testeVenda(Cliente cliente, List<Produto> produtos, FormaPagamento formaPagamento, String cartao_credito, String dataHora, double valorTotalEsperado, double descontoEsperado, double freteEsperado, double icmsEsperado, double impostoMunicipalEsperado, double cashbackEsperado, String dataHoraEsperado){
